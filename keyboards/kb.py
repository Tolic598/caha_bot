...
b6  = InlineKeyboardButton(text="📋Помощь📋", callback_data="Info_admin")
menu = InlineKeyboardMarkup(row_width=1)
menu.row(b1).row(b2,b3).row(b4).row(b5,b6)
...
kbpt.row(b1).row(b3).row(b4) #в ряд
...
'''#''''''''''''''''''''''''''''''''''''''''проверка пополнения''''''''''''''''''''''''''''''''''''''''''''#'''
b1  = InlineKeyboardButton(text="Проверить", callback_data="popprov")
b2  = InlineKeyboardButton(text="Отмена", callback_data="otmena_pop")
pop_prov = InlineKeyboardMarkup(row_width=1)
pop_prov.row(b1).row(b2) #в ряд

'''#''''''''''''''''''''''''''''''''''''''''проверка ВЫВОДА''''''''''''''''''''''''''''''''''''''''''''#'''
b1  = InlineKeyboardButton(text="Отмена", callback_data="otmena_viv")
viv_prov = InlineKeyboardMarkup(row_width=1)
viv_prov.row(b1)#в ряд
...
b4  = InlineKeyboardButton(text="Отключить приветствие", callback_data="greetings_chat_off")
b5  = InlineKeyboardButton(text="Включить приветствие", callback_data="greetings_chat_on")
kbadmin_chat = InlineKeyboardMarkup(row_width=1)
kbadmin_chat.row(b1).row(b2,b3).row(b4,b5)
...
'''#''''''''''''''''''''''''''''''''''''''''Админка отмена''''''''''''''''''''''''''''''''''''''''''''#'''
b1  = InlineKeyboardButton(text="Отмена", callback_data="otmena_admin")
otmenaadmin = InlineKeyboardMarkup(row_width=1)
otmenaadmin.row(b1)

'''#''''''''''''''''''''''''''''''''''''''''hегестрация колесо фортуны''''''''''''''''''''''''''''''''''''''''''''#'''
b1  = InlineKeyboardButton(text="🍀Испытать удачу🍀", callback_data="rand_ruli")
reg_col = InlineKeyboardMarkup(row_width=1)
reg_col.row(b1)

'''#''''''''''''''''''''''''''''''''''''''''помощь''''''''''''''''''''''''''''''''''''''''''''#'''
b1  = InlineKeyboardButton(text="💬Связь с админом💬", callback_data="ras_admin")
b2  = InlineKeyboardButton(text="🤖Заказать проект🤖", url='t.me/codetolic')
b3  = InlineKeyboardButton(text="🏠Главное меню🏠", callback_data="Menu")
helps = InlineKeyboardMarkup(row_width=1)
helps.row(b1).row(b2).row(b3)

'''#''''''''''''''''''''''''''''''''''''''''отправка сообщению админу''''''''''''''''''''''''''''''''''''''''''''#'''
b1  = InlineKeyboardButton(text="✅Ответит✅ь", callback_data="otvetit")
b2  = InlineKeyboardButton(text="📛Игнорировать сообщение📛", callback_data="deley")
otmena_admins = InlineKeyboardMarkup(row_width=1)
otmena_admins.row(b1).row(b2)

'''#''''''''''''''''''''''''''''''''''''''''подтвердить вывод''''''''''''''''''''''''''''''''''''''''''''#'''
b1  = InlineKeyboardButton(text="✅Подтвердить вывод✅", callback_data="oplata_y")
oplata_yes = InlineKeyboardMarkup(row_width=1)
oplata_yes.row(b1)
